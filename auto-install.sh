...
CONFIG_FILE='cleansolutions.conf'
CONFIGFOLDER='/root/.cleansolutions'
COIN_DAEMON='/usr/local/bin/cleansolutionsd'
COIN_CLI='/usr/local/bin/cleansolutions-cli'
COIN_REPO='https://github.com/ScottStultz/cleansolutions/releases/download/v1.0/CleanSolutions-linux.tgz'
COIN_NAME='CleanSolutions'
COIN_PORT=8322
...
function compile_node() {
  ...
  cp cleansolutions* /usr/local/bin
  compile_error
