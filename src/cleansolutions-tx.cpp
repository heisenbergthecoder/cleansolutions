...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CleanSolutions Core cleansolutions-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cleansolutions-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cleansolutions transaction") + "\n" +
                               "  cleansolutions-tx [options] -create [commands]   " + _("Create hex-encoded cleansolutions transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cleansolutions transaction
