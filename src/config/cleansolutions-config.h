/* src/config/cleansolutions-config.h.  Generated from cleansolutions-config.h.in by configure.  */
/* src/config/cleansolutions-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://cleansolutions.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CleanSolutions Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CleanSolutions Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cleansolutions"
