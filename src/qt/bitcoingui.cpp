                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CleanSolutions-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CleanSolutions address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cleansolutions: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CleanSolutions Core"), this);
    aboutAction->setStatusTip(tr("Show information about CleanSolutions Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CleanSolutions"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CleanSolutions addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CleanSolutions addresses"));
    ...
    openAction->setStatusTip(tr("Open a CleanSolutions: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CleanSolutions Core help message to get a list with possible CleanSolutions command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CleanSolutions Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CleanSolutions network", "", count));
}
...
{
    QString strTitle = tr("CleanSolutions Core"); // default title
