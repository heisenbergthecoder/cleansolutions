...
/** Utility functions used by the CSN Qt UI.
 */
namespace GUIUtil
{
...
// Render CSN addresses in monospace font
...
// Parse "cleansolutions:" URI into recipient object, return true on successful parsing
