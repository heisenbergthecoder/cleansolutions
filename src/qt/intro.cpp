...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CleanSolutions Core"),
     ...
     * override -datadir in the cleansolutions.conf file in the default data directory
     * (to be consistent with cleansolutionsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
